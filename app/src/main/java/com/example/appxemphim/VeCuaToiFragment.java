...
import com.example.appxemphim.THONGTINPHIM.TTPhimFragment;
import com.example.appxemphim.Trangchu.TrangChuFragment;
import com.example.appxemphim.danhgia.DanhGiaFragment;
...
public class VeCuaToiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment newFragment = new KhacFragment();
